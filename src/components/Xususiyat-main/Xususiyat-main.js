    ...
    <div className="container">
        ...
        <div className="x-one">
          <div>
            ...
            <p className="xone-text x-t">
              ...
              Pellentesque nec ex in nunc cursus posuere at non augue. Lorem
              ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque
              interdum, felis et bibendum finibus, risus
            </p>
          </div>
      ...
      <Fade bottom>
        <div className="x-three">
          ...
          <div>
            <img className="apple-tel" src={Apple3} alt="apple" />
          </div>
        </div>
      </Fade>
      <Fade bottom>
        ...
        <div className="main-three">
          <div className="three-left">
            ...
            <p className="three-text x-t">
              ...
              uchun profil ko‘rinishlari va alohida havola bosishlarini
              kuzating.
            </p>
          </div>
          <div>
        ...
        <div className="x-five">
          ...
          <div className="xfive-right x-right">
            ...
            <p className="xfive-text x-t">
              ...
              Pellentesque nec ex in nunc cursus posuere at non augue. Lorem
              ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque
              interdum, felis et bibendum finibus, risus quam sollicitudin
              neque, eu tristique lorem felis nec massa. Pellentesque nec ex in
